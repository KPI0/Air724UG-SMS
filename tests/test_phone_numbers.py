...
class PhoneNumbersTests(unittest.TestCase):
    ...
    def test_normalize_call_number_preserves_local_numbers(self):
        ...
        self.assertEqual(normalize_call_number("13123123123"), "13123123123")
    ...
    def test_normalize_call_number_handles_international_non_china(self):
        ...
        self.assertEqual(normalize_call_number("+12345678910"), "+12345678910")
    ...
    def test_normalize_call_number_strips_whitespace(self):
        ...
        self.assertEqual(normalize_call_number("  13123123123  "), "13123123123")
        self.assertEqual(normalize_call_number("\t+8613123123123\n"), "13123123123")
    ...
    def test_normalize_call_number_distinguishes_by_length(self):
        ...
        # 8613123123123 (13 digits) -> remove 86
        self.assertEqual(normalize_call_number("8613123123123"), "13123123123")
