...
class CloudProtocolTests(unittest.TestCase):
    ...
    def test_parse_sms_callback_head_handles_phone_without_plus(self):
        ...
        text = '13800138000 24/12/25,14:30:45+32 Message'
        phone, message = parse_sms_callback_head(text)
