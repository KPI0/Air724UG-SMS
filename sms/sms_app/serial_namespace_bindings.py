...
def install_serial_namespace_bindings(namespace):
    ...
    namespace.update({
        ...
        "mark_dial_connected": bind("mark_dial_popup_connected_namespace_runtime"),
        "mark_call_connected": bind("mark_call_popup_connected_namespace_runtime"),
        "mark_peer_call_connected": bind("mark_peer_incoming_call_connected_namespace_runtime"),
        "finish_dial_call": bind("finish_dial_popup_namespace_runtime"),
        ...
        "finish_remote_incoming_call": bind("finish_remote_incoming_call_namespace_runtime"),
        "register_peer_incoming_call": bind("register_peer_incoming_call_namespace_runtime"),
